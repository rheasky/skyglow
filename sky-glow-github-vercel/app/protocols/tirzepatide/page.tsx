...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Tirzepatide Protocol | SKY GLOW", description: "Protocol information for SKY GLOW Tirzepatide 15 mg and 30 mg vials.", images: [{ url: "/TIRZEPATIDE%20PROTOCOL.png", alt: "SKY GLOW Tirzepatide protocol" }] },
  twitter: { card: "summary_large_image", images: ["/TIRZEPATIDE%20PROTOCOL.png"] },
};
  ...
  return (
    <main className="protocol-page">
      ...
      <section className="protocol-page-content">
        <p className="eyebrow">PRODUCT PROTOCOL</p><h1>Tirzepatide</h1><p className="protocol-page-dose">For 15 mg and 30 mg vials</p>
        <img className="protocol-document" src="/TIRZEPATIDE%20PROTOCOL.png" alt="Tirzepatide protocol for 15 mg and 30 mg vials" />
